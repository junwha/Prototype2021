...
class ArticleLoader {
  Future<List<EventPreviewData>> loadSearchResults(
    ...
    try {
      ...
      Logger.errorWithInfo(e, "article_loader.dart -> loadSearchResults");
    }
  ...
  Future<List<EventTimerData>> loadTopEventArticles(
    ...
    try {
      ...
      Logger.errorWithInfo(e, "article_loader.dart -> loadTopEventArticles");
    }
  ...
  List<EventTimerData> parseTopEventArticle(String jsonString) {
    ...
    for (Map<String, dynamic> data in jsonData) {
      try {
        ...
        Logger.errorWithInfo(e, "article_loader.dart -> parseTopEventArticle");
      }
    }
    return articleList;
  }
  ...
  Future<List<EventPreviewData>> loadEventArticles(
    ...
    try {
      ...
      Logger.errorWithInfo(e, "article_loader.dart -> loadEventArticles");
    }
  ...
  List<EventPreviewData> parseEventArticle(String jsonString) {
    ...
    for (Map<String, dynamic> data in jsonData["results"]) {
      try {
        ...
        Logger.errorWithInfo(e, "article_loader.dart -> ");
      }
    }
    return articleList;
  }
  ...
  Future<ArticleDetailData?> loadArticleDetail(
    ...
    try {
      ...
      try {
        ...
        Logger.errorWithInfo(e, "article_loader.dart -> loadArticleDetail");
      }
    } catch (e) {
      Logger.errorWithInfo(e, "article_loader.dart -> loadArticleDetail");
    }
